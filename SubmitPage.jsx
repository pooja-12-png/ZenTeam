    ...
    <div style={styles.container}>
      ...
      <div style={styles.section}>
        ...
        <pre style={styles.pre}>
          {JSON.stringify(
            {
              policyCoverage: formData.policyCoverage,
              policyBoardApproval: formData.policyBoardApproval,
              policyWebLinks: formData.policyWebLinks,
            },
            null,
            2
          )}
      ...
      {/* Section C */}
      <div style={styles.section}>
        <h3 style={styles.sectionTitle}>Section C – Principle-wise Performance</h3>
        <pre style={styles.pre}>
          {JSON.stringify(
            {
      ...
      {/* Section E */}
      <div style={styles.section}>
        <h3 style={styles.sectionTitle}>Section E – Holding / Subsidiary Companies</h3>
        <pre style={styles.pre}>
          {JSON.stringify(
            {
      ...
      {/* Section G */}
      <div style={styles.section}>
        <h3 style={styles.sectionTitle}>Section G – Transparency & Disclosure</h3>
        <pre style={styles.pre}>
          {JSON.stringify(
            {
